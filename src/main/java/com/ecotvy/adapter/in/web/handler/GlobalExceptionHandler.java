package com.ecotvy.adapter.in.web.handler;

import com.ecotvy.infrastructure.dto.response.ApiResponse;
import com.ecotvy.infrastructure.error.dto.ErrorResponse;
...
import com.ecotvy.infrastructure.jenkins.exception.JenkinsBuildException;
import com.ecotvy.infrastructure.jenkins.exception.JenkinsConnectionException;
import com.ecotvy.infrastructure.jenkins.exception.JenkinsException;
import com.ecotvy.infrastructure.jenkins.exception.JenkinsJobNotFoundException;
...
public class GlobalExceptionHandler {
     ...
     * 커스텀 인증 예외 처리
     */
    @ExceptionHandler(com.ecotvy.infrastructure.exception.AuthenticationException.class)
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAuthenticationException(com.ecotvy.infrastructure.exception.AuthenticationException e,
